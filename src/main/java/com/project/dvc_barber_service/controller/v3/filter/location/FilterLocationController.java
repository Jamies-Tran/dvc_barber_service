...
public class FilterLocationController implements IFilterLocationAPI {
    ...
    public ResponseEntity<?> findAll(String search,
        ...
        try {
            ...
            LocationResponse location = useCase.findAll(searchCriteria);
            com.project.dvc_barber_service.controller.v3.filter.location.models.LocationResponse response = modelMapper.toModel(location);
