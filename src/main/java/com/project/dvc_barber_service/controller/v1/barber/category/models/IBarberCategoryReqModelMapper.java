...
public interface IBarberCategoryReqModelMapper extends IModelMapper<BarberCategoryRequest, BarberCategory> {
    BarberCategory toDto(BarberCategoryUpdateRequest model);
}
